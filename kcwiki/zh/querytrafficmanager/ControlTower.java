        ...
        switch(channel){
                ...
                case "area":
                    ...
                    if(!jedis.exists(querystring)) {
                        result = JSON.toJSONString(new org.kcwiki.zh.spider.poidb.mainpage().test());
                ...
                case "map":
                    ...
                    if(!jedis.exists(querystring)) {
                        result = JSON.toJSONString(new org.kcwiki.zh.spider.poidb.mainpage().test1(mapno));
                ...
                case "point":
                    ...
                    if(!jedis.exists(querystring)) {
                        result = JSON.toJSONString(new org.kcwiki.zh.spider.poidb.api().test(mapno,point,difficulty,assessment));
                        jedis.set(querystring, result);
                    } else {
                        result = jedis.get(querystring);
                    }
                ...
                case "expedition":
                    ...
                    if(!jedis.exists(querystring)) {
                        result = JSON.toJSONString(new org.kcwiki.zh.spider.wikiexpedition.mainpage().test());
                        jedis.set(querystring, result);
                    } else {
                        result = jedis.get(querystring);
                    }
                ...
                case "mapfast":
                    querystring = "mapfast" ;
                    if(!jedis.exists(querystring)) {
                        result = JSON.toJSONString(new org.kcwiki.zh.spider.wikimap.fastSearch().test());
                        jedis.set(querystring, result);
                    } else {
                        result = jedis.get(querystring);
                    }
                ...
                case "akashitype":
                    ...
                    if(!jedis.exists(querystring)) {
                        result = JSON.toJSONString(new org.kcwiki.zh.spider.akashilist.mainpage().getTypeList());
                        jedis.set(querystring, result);
                    } else {
                        result = jedis.get(querystring);
                    }
                ...
                case "akashilist":
                    ...
                    if(!jedis.exists(querystring)) {
                        result = JSON.toJSONString(new org.kcwiki.zh.spider.akashilist.mainpage().getItemList(type));
                        jedis.set(querystring, result);
                    } else {
                        result = jedis.get(querystring);
                    }
                ...
                case "thankslist":
                    ...
                    if(!jedis.exists(querystring)) {
                        result = JSON.toJSONString(new org.kcwiki.zh.spider.akashilist.thankslist().test1());
                        jedis.set(querystring, result);
                    } else {
                        result = jedis.get(querystring);
                    }
