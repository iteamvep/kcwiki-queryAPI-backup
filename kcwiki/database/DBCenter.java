...
public class DBCenter {
    ...
    public static HashMap<Integer,JSONObject> questsMap = new LinkedHashMap<>();
    public static HashMap<Integer,JSONObject> unknownQuestMap = new LinkedHashMap<>();
    public static HashMap<Integer,Set<Integer>> unknownQuestConjecture = new LinkedHashMap<>();
    public static HashMap<Integer,Integer> unknownQuestCounter = new LinkedHashMap<>();
